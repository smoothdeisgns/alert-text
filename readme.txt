...
A simple "Hello World" plugin that demonstrates basic plugin structure and includes a GitHub-based update checker.

== Description ==

This plugin serves as a starting point for developing WordPress plugins that are hosted on GitHub. It performs a single, simple action: displaying a "Hello World" alert box on the front end of your site.
